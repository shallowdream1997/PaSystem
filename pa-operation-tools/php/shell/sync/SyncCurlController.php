...
//        die("111");
        ...
        $fileFitContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/fitment.xlsx");
        $fitmentSkuMap = [];
        ...
        $fileFitContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/cpasin.xlsx");
        $cpSkuMap = [];
        if (sizeof($fileFitContent) > 0) {
            foreach ($fileFitContent as $info){
...
//        }while(true);
         ...
         */
        //$fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/重复T号test.xlsx");
...
//            }
            ...
            $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/qd/补充的T号.xlsx");
            $titleCnMap = [];
            foreach ($fileContent as $info){
...
//        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/pmo/ppms_{$pmoBillNo}.xlsx");
//        $pmoContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/pmo/{$pmoBillNo}.xlsx");
//        $pmoSkuMap = [];
...
//            }
    ...
    public function updateSampleSku(){
        ...
        $env = "pro";
        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/留样CP.xlsx");
    ...
    public function updateFcuProductLine(){
        ...
        $env = "pro";
        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/skufcu.xlsx");
    ...
    public function updateProductFba(){
        ...
        $env = "pro";
        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/fba.xlsx");
    ...
    public function combineFC(){
        $env = "pro";
        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/FCU.xlsx");
    ...
    public function updateProductListNo(){
        $env = "pro";
        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/productListNo.xlsx");
...
//        $skuIdList = array_column($res,"skuId");
    ...
    public function fixProductOpt(){
        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/资料图片工单.xlsx");
...
//        }
        ...
        $fileContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/uploads/default/sku资料呈现热销词_20250429223726.xlsx");
...
//        }
    ...
    public function updateSkuMaterial(){
        ...
        $fileFitContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/CEB.xlsx");
        $fitmentSkuMap = [];
        if (sizeof($fileFitContent) > 0) {
...
//        }
    ...
    public function fix(){
        ...
        $fileFitContent = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/pmo.xlsx");

        $fileFitContent1 = (new ExcelUtils())->getXlsxData(PA_EXPORT_PATH . "/DPMO250424008-黎乾海.xlsx");
